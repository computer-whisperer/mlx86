...
int main(int argc, char **argv) {
  ...
  if (false)
  {
    ...
    player->append_instruction(BAR_Instruction_Build, BAR_UnitType_armmex, 5);
    player->append_instruction(BAR_Instruction_Build, BAR_UnitType_armtide, 10);
    player->append_instruction(BAR_Instruction_Build, BAR_UnitType_armsy, 1);
    player->append_instruction(BAR_Instruction_Build, BAR_UnitType_armroy, 5);
  }
