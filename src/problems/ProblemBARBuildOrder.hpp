...
public:
  ...
  explicit ProblemBARBuildOrder(uint32_t n_instructions=200): num_instructions(n_instructions), Problem(sizeof(Game<BAR_game_config>::Instruction) * n_instructions){};
